...
public class uEye_defines
{
	...
	public const int IS_SE_STARTER_FW_UPLOAD = 1;
    public const int IS_CP_STARTER_FW_UPLOAD = 2;
    public const int IS_STARTER_FW_UPLOAD = 4; 
	...
	public const int IS_SET_TRIGGER_OFF = 0x0;
	public const int IS_SET_TRIGGER_HI_LO = 0x1001;
	public const int IS_SET_TRIGGER_LO_HI = 0x1002;
	public const int IS_SET_TRIGGER_SOFTWARE = 0x1008;
    ...
    public const int IS_LOW_COLOR_REMOVAL = 13;
    public const int IS_CHROMA_COMB_FILTER = 14;
    public const int IS_CHROMA_AGC = 15;
    public const int IS_WATCHDOG_ON_BOARD = 16;
    public const int IS_PASSTHROUGH_ON_BOARD = 17;
    public const int IS_EXTERNAL_VREF_MODE = 18;
    ...
    public const int IS_PARAMETER_EXT = 27;
